...
const {default: TypeSerializer} = await load('./Serializers/TypeSerializer.js')
...
const {default: FateAccountAddress} = await load('./types/FateAccountAddress.js')
const {default: FateContractAddress} = await load('./types/FateContractAddress.js')
const {default: FateOracleAddress} = await load('./types/FateOracleAddress.js')
const {default: FateOracleQueryAddress} = await load('./types/FateOracleQueryAddress.js')
const {default: FateChannelAddress} = await load('./types/FateChannelAddress.js')
...
const values = {
    ...
    'variant/some': new FateVariant([0, 1], 1, [new FateInt(42)], [FateTypeInt()]),
    ...
    'calldata/no-args': new FateCalldata(new Uint8Array([0xb2, 0xba, 0x9d, 0x59]), [], []),
...
const types = {
    ...
    'type/map-string-to-list': FateTypeMap(FateTypeString(), FateTypeList(FateTypeInt())),
    'type/unit': FateTypeTuple(),
    'type/tuple': FateTypeTuple([FateTypeInt(), FateTypeBool()]),
    'type/option-int': FateTypeVariant([FateTypeTuple(), FateTypeTuple([FateTypeInt()])]),
