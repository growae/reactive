...
export const FAUCET_PUBLIC_KEY = 'ak_2mwRmUeYmfuW93ti9HMSUJzCk1EYcQEfikVSzgo6k2VghsWhgU'
...
export async function waitForNode(
  ...
  throw new Error(`Node at ${url} did not become ready within ${maxRetries * intervalMs}ms`)
}
